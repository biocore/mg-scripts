    ...
    exp_map = {'QCJob_Feist_11661.array-details': {
               ...
               'QCJob_Gerwick_6123.array-details': {
                   'first_line': "fastp --adapter_sequence AACC --adapter_sequ"
                                 ...
                                 "utput_dir/QCJob/Gerwick_6123/json/3A_R1_001."
                                 "json -h sequence_processing_pipeline/tests/d"
                                 "ata/output_dir/QCJob/Gerwick_6123/html/3A_R1"
                                 "_001.html -o sequence_processing_pipeline/te"
                                 "sts/data/output_dir/QCJob/Gerwick_6123/trimm"
                                 "ed_sequences/3A_R1_001.fastp.fastq.gz -O seq"
                                 "uence_processing_pipeline/tests/data/output_"
                                 "dir/QCJob/Gerwick_6123/trimmed_sequences/3A_"
                                 "R2_001.fastp.fastq.gz -R 3A_R1_001_report",
                   'last_line': "fastp --adapter_sequence AACC --adapter_sequ"
                                ...
                                "/output_dir/QCJob/Gerwick_6123/json/ISB_R1_0"
                                "01.json -h sequence_processing_pipeline/test"
                                "s/data/output_dir/QCJob/Gerwick_6123/html/IS"
                                "B_R1_001.html -o sequence_processing_pipelin"
                                "e/tests/data/output_dir/QCJob/Gerwick_6123/t"
                                "rimmed_sequences/ISB_R1_001.fastp.fastq.gz -"
                                "O sequence_processing_pipeline/tests/data/ou"
                                "tput_dir/QCJob/Gerwick_6123/trimmed_sequence"
                                "s/ISB_R2_001.fastp.fastq.gz -R ISB_R1_001_re"
                                "port",
                   'count': 9},
               'QCJob_NYU_BMS_Melanoma_13059.array-details': {
                   'first_line': "fastp --adapter_sequence AACC "
