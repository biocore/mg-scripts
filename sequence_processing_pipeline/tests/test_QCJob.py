...
class TestQCJob(unittest.TestCase):
    ...
    exp_map = {'QCJob_Feist_11661.array-details': {
               ...
               'QCJob_Gerwick_6123.array-details': {
                   'first_line': "fastp --adapter_sequence AACC --adapter_sequ"
                                 ...
                                 "fastq.gz",
                   'last_line': "fastp --adapter_sequence AACC --adapter_se"
                                "quence_r2 GGTT -l 100 -i sequence_processi"
                                "ng_pipeline/tests/data/output_dir/ConvertJ"
                                "ob/Gerwick_6123/ISB_R1_001.fastq.gz -I seq"
                                "uence_processing_pipeline/tests/data/outpu"
                                "t_dir/ConvertJob/Gerwick_6123/ISB_R2_001.f"
                                "astq.gz -w 16 -j sequence_processing_pipel"
                                "ine/tests/data/output_dir/QCJob/Gerwick_61"
                                "23/fastp_reports_dir/json/ISB_R1_001.json "
                                "-h sequence_processing_pipeline/tests/data"
                                "/output_dir/QCJob/Gerwick_6123/fastp_repor"
                                "ts_dir/html/ISB_R1_001.html --stdout | min"
                                "imap2 -ax sr -t 16 sequence_processing_pip"
                                "eline/tests/data/mmi.db - -a | samtools fa"
                                "stq -@ 16 -f 12 -F 256 -1 sequence_process"
                                "ing_pipeline/tests/data/output_dir/QCJob/G"
                                "erwick_6123/filtered_sequences/ISB_R1_001."
                                "trimmed.fastq.gz -2 sequence_processing_pi"
                                "peline/tests/data/output_dir/QCJob/Gerwick"
                                "_6123/filtered_sequences/ISB_R2_001.trimme"
                                "d.fastq.gz",
                   'count': 9},
               'QCJob_NYU_BMS_Melanoma_13059.array-details': {
                   'first_line': "fastp --adapter_sequence AACC "
    ...
    exp_map_chained = {'QCJob_Feist_11661.array-details': {
        'first_line': "fastp --adapter_sequence AACC --adapter_sequence_r2 GG"
                      "TT -l 100 -i sequence_processing_pipeline/tests/data/o"
                      "utput_dir/ConvertJob/Feist/AB5075_AZM_TALE_in_MHB_A_ba"
                      "umannii_AB5075_WT_17_25_R1_001.fastq.gz -I sequence_pr"
                      "ocessing_pipeline/tests/data/output_dir/ConvertJob/Fei"
                      "st/AB5075_AZM_TALE_in_MHB_A_baumannii_AB5075_WT_17_25_"
                      "R2_001.fastq.gz -w 16 -j sequence_processing_pipeline/"
                      "tests/data/output_dir/QCJob/Feist_11661/json/AB5075_AZ"
                      "M_TALE_in_MHB_A_baumannii_AB5075_WT_17_25_R1_001.json "
                      "-h sequence_processing_pipeline/tests/data/output_dir/"
                      "QCJob/Feist_11661/html/AB5075_AZM_TALE_in_MHB_A_bauman"
                      "nii_AB5075_WT_17_25_R1_001.html -o sequence_processing"
                      "_pipeline/tests/data/output_dir/QCJob/Feist_11661/trim"
                      "med_sequences/AB5075_AZM_TALE_in_MHB_A_baumannii_AB507"
                      "5_WT_17_25_R1_001.fastp.fastq.gz -O sequence_processin"
                      "g_pipeline/tests/data/output_dir/QCJob/Feist_11661/tri"
                      "mmed_sequences/AB5075_AZM_TALE_in_MHB_A_baumannii_AB50"
                      "75_WT_17_25_R2_001.fastp.fastq.gz -R AB5075_AZM_TALE_i"
                      "n_MHB_A_baumannii_AB5075_WT_17_25_R1_001_report;fastp "
                      "--adapter_sequence AACC --adapter_sequence_r2 GGTT -l "
                      "100 -i sequence_processing_pipeline/tests/data/output_"
                      "dir/ConvertJob/Feist/P21_E_coli_ELI344_R1_001.fastq.gz"
                      " -I sequence_processing_pipeline/tests/data/output_dir"
                      "/ConvertJob/Feist/P21_E_coli_ELI344_R2_001.fastq.gz -w"
                      " 16 -j sequence_processing_pipeline/tests/data/output_"
                      "dir/QCJob/Feist_11661/json/P21_E_coli_ELI344_R1_001.js"
                      "on -h sequence_processing_pipeline/tests/data/output_d"
                      "ir/QCJob/Feist_11661/html/P21_E_coli_ELI344_R1_001.htm"
                      "l -o sequence_processing_pipeline/tests/data/output_di"
                      "r/QCJob/Feist_11661/trimmed_sequences/P21_E_coli_ELI34"
                      "4_R1_001.fastp.fastq.gz -O sequence_processing_pipelin"
                      "e/tests/data/output_dir/QCJob/Feist_11661/trimmed_sequ"
                      "ences/P21_E_coli_ELI344_R2_001.fastp.fastq.gz -R P21_E"
                      "_coli_ELI344_R1_001_report",

        'last_line': "fastp --adapter_sequence AACC --adapter_sequence_"
                     "r2 GGTT -l 100 -i sequence_processing_pipeline/te"
                     "sts/data/output_dir/ConvertJob/Feist/JM-Metabolic"
                     "__GN0_2404_R1_001.fastq.gz -I sequence_processing"
                     "_pipeline/tests/data/output_dir/ConvertJob/Feist/"
                     "JM-Metabolic__GN0_2404_R2_001.fastq.gz -w 16 -j s"
                     "equence_processing_pipeline/tests/data/output_dir"
                     "/QCJob/Feist_11661/json/JM-Metabolic__GN0_2404_R1"
                     "_001.json -h sequence_processing_pipeline/tests/d"
                     "ata/output_dir/QCJob/Feist_11661/html/JM-Metaboli"
                     "c__GN0_2404_R1_001.html -o sequence_processing_pi"
                     "peline/tests/data/output_dir/QCJob/Feist_11661/tr"
                     "immed_sequences/JM-Metabolic__GN0_2404_R1_001.fas"
                     "tp.fastq.gz -O sequence_processing_pipeline/tests"
                     "/data/output_dir/QCJob/Feist_11661/trimmed_sequen"
                     "ces/JM-Metabolic__GN0_2404_R2_001.fastp.fastq.gz "
                     "-R JM-Metabolic__GN0_2404_R1_001_report",
        'count': 250},
        'QCJob_Gerwick_6123.array-details': {
            'first_line': "fastp --adapter_sequence AACC --adapter_sequence_r"
                          "2 GGTT -l 100 -i sequence_processing_pipeline/test"
                          "s/data/output_dir/ConvertJob/Gerwick_6123/3A_R1_00"
                          "1.fastq.gz -I sequence_processing_pipeline/tests/d"
                          "ata/output_dir/ConvertJob/Gerwick_6123/3A_R2_001.f"
                          "astq.gz -w 16 -j sequence_processing_pipeline/test"
                          "s/data/output_dir/QCJob/Gerwick_6123/fastp_reports"
                          "_dir/json/3A_R1_001.json -h sequence_processing_pi"
                          "peline/tests/data/output_dir/QCJob/Gerwick_6123/fa"
                          "stp_reports_dir/html/3A_R1_001.html --stdout | min"
                          "imap2 -ax sr -t 16 sequence_processing_pipeline/te"
                          "sts/data/mmi.db - -a | samtools fastq -@ 16 -f 12 "
                          "-F 256 -1 sequence_processing_pipeline/tests/data/"
                          "output_dir/QCJob/Gerwick_6123/filtered_sequences/3"
                          "A_R1_001.trimmed.fastq.gz -2 sequence_processing_p"
                          "ipeline/tests/data/output_dir/QCJob/Gerwick_6123/f"
                          "iltered_sequences/3A_R2_001.trimmed.fastq.gz",
            'last_line': "fastp --adapter_sequence AACC --adapter_sequence_r2"
                         " GGTT -l 100 -i sequence_processing_pipeline/tests/"
                         "data/output_dir/ConvertJob/Gerwick_6123/ISB_R1_001."
                         "fastq.gz -I sequence_processing_pipeline/tests/data"
                         "/output_dir/ConvertJob/Gerwick_6123/ISB_R2_001.fast"
                         "q.gz -w 16 -j sequence_processing_pipeline/tests/da"
                         "ta/output_dir/QCJob/Gerwick_6123/fastp_reports_dir/"
                         "json/ISB_R1_001.json -h sequence_processing_pipelin"
                         "e/tests/data/output_dir/QCJob/Gerwick_6123/fastp_re"
                         "ports_dir/html/ISB_R1_001.html --stdout | minimap2 "
                         "-ax sr -t 16 sequence_processing_pipeline/tests/dat"
                         "a/mmi.db - -a | samtools fastq -@ 16 -f 12 -F 256 -"
                         "1 sequence_processing_pipeline/tests/data/output_di"
                         "r/QCJob/Gerwick_6123/filtered_sequences/ISB_R1_001."
                         "trimmed.fastq.gz -2 sequence_processing_pipeline/te"
                         "sts/data/output_dir/QCJob/Gerwick_6123/filtered_seq"
                         "uences/ISB_R2_001.trimmed.fastq.gz",
            'count': 9},
        'QCJob_NYU_BMS_Melanoma_13059.array-details': {
